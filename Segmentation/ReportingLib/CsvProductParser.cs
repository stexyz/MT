...
namespace ReportingLib {
    ...
    {
        private static readonly List<Product> PaymentProducts = new List<Product>
            {
        ...
        private static readonly List<Product> ShippingProducts = new List<Product>{ 
        ...
        public static bool IsShipping(Product product)
        {
            return ShippingProducts.Contains(product);
        }

        public static bool IsPayment(Product product) {
            return PaymentProducts.Contains(product);
        }
